...
from agent_dir.agent import root_agent
from agent_dir.utils.gcs import create_bucket_if_not_exists
from agent_dir.utils.tracing import CloudTraceLoggingSpanExporter
from agent_dir.utils.typing import Feedback
...
def deploy_agent_engine_app(
    ...
    extra_packages: list[str] = ["./agent_dir"],
    ...
    artifacts_bucket_name = f"{project}-planner-botda-logs-data"
